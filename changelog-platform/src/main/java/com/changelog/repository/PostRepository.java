...
public interface PostRepository extends JpaRepository<Post, UUID> {
    ...
    @Query("SELECT p FROM Post p JOIN FETCH p.tags WHERE p.projectId = :projectId AND p.id = :postId")
    Optional<Post> findByIdWithTags(@Param("projectId") UUID projectId, @Param("postId") UUID postId);
